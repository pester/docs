...
Pester test script filenames _must_ end with `.Tests.ps1` suffix in order for [Invoke-Pester](../commands/New-Pester)
...
In addition to filename discovery of the `\*.Tests.ps1` pattern by the [Invoke-Pester](../commands/New-Pester)
