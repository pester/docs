...
```powershell
Should-BeAfter [[-Actual] <Object>] [-Now] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Fluent

```powershell
Should-BeAfter [[-Actual] <Object>] [[-Time] <Object>] [-Ago] [-FromNow] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Should-BeAfter [[-Actual] <Object>] [[-Expected] <DateTime>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
