...
```powershell
Should-BeAfter [[-Actual] <Object>] [[-Time] <String>] [-FromNow] [-Because <String>]
```

### FluentAgo

```powershell
Should-BeAfter [[-Actual] <Object>] [[-Time] <String>] [-Ago] [-Because <String>]
```

### Expected

```powershell
Should-BeAfter [[-Actual] <Object>] [[-Expected] <DateTime>] [-Because <String>]
```
