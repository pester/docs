...
id: InModuleScope
title: InModuleScope
description: Help page for the PowerShell Pester 'InModuleScope' command - Allows you to execute parts of a test script within thescope of a PowerShell script or manifest module.
keywords:
  - PowerShell
  - Pester
  - Help
