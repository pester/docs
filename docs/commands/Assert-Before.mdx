...
```powershell
Assert-Before [[-Actual] <Object>] [-Now] [<CommonParameters>]
```

### Fluent

```powershell
Assert-Before [[-Actual] <Object>] [[-Time] <Object>] [-Ago] [-FromNow] [<CommonParameters>]
```

### Expected

```powershell
Assert-Before [[-Actual] <Object>] [[-Expected] <DateTime>] [<CommonParameters>]
```
