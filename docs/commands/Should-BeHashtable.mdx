...
description: Help for Pester command 'Should-BeHashtable'. Asserts that the input is a hashtable or dictionary, and optionally checks the number of entries, whether it is ordered, and that it contains specific keys.
keywords:
  - PowerShell
  - Pester
  - Help
