...
description: Help page for the PowerShell Pester "Should-BeGreaterThan" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-BeGreaterThan [[-Actual] <Object>] [-Expected] <Object> [-Because <String>] [<CommonParameters>]
```
