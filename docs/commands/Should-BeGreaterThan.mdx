...
description: Help page for the PowerShell Pester 'Should-BeGreaterThan' command - Compares the expected value to actual value, to see if the actual value is greater than the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
