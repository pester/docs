---
id: Should-BeGreaterThan
title: Should-BeGreaterThan
description: Help for Pester command 'Should-BeGreaterThan'. Compares the expected value to actual value, to see if the actual value is greater than the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-BeGreaterThan [-Expected] <Object> [[-Actual] <Object>] [-Because <string>]
```
