...
description: "Help page for the PowerShell Pester 'Should-BeFalsy' command - Compares the actual value to a boolean $false or a falsy value: 0, \"\", $null or @(). It converts the input value to a boolean."
keywords:
  - PowerShell
  - Pester
  - Help
