...
description: Help page for the PowerShell Pester "Should-BeGreaterThanOrEqual" command
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-BeGreaterThanOrEqual [[-Actual] <Object>] [-Expected] <Object> [-Because <String>] [<CommonParameters>]
```
