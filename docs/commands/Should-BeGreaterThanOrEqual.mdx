...
description: Help page for the PowerShell Pester 'Should-BeGreaterThanOrEqual' command - Compares the expected value to actual value, to see if the actual value is greater than or equal to the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
