---
id: Should-BeLikeString
title: Should-BeLikeString
description: Help for Pester command 'Should-BeLikeString'. Asserts that the actual value is like the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-BeLikeString [-Expected] <string> [[-Actual] <Object>] [-CaseSensitive] [-Because <string>]
```
