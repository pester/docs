...
id: Should-Invoke
title: Should-Invoke
description: Help page for the PowerShell Pester 'Should-Invoke' command - Checks if a Mocked command has been called a certain number of timesand throws an exception if it has not.
keywords:
  - PowerShell
  - Pester
  - Help
