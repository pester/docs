...
description: Help for Pester command 'Should-BeFalse'. Compares the actual value to a boolean $false. It does not convert input values to boolean, and will fail for any value that is not $false.
keywords:
  - PowerShell
  - Pester
  - Help
