...
description: Help page for the PowerShell Pester 'Should-NotBeSame' command - Compares the expected value to actual value, to see if the actual value is not the same instance as the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
