...
description: Help for Pester command 'Should-NotBeSame'. Compares the expected value to actual value, to see if the actual value is not the same instance as the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
