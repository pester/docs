...
```powershell
It [-Name] <String> [[-Test] <ScriptBlock>] [-TestCases <IDictionary[]>] [-Tag <String[]>] [<CommonParameters>]
```

### Pending

```powershell
It [-Name] <String> [[-Test] <ScriptBlock>] [-TestCases <IDictionary[]>] [-Tag <String[]>] [-Pending]
 [<CommonParameters>]
```
...
```powershell
It [-Name] <String> [[-Test] <ScriptBlock>] [-TestCases <IDictionary[]>] [-Tag <String[]>] [-Skip]
 [<CommonParameters>]
```
