...
```powershell
Should-BeBefore [[-Actual] <Object>] [-Now] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Fluent

```powershell
Should-BeBefore [[-Actual] <Object>] [[-Time] <Object>] [-Ago] [-FromNow] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Should-BeBefore [[-Actual] <Object>] [[-Expected] <DateTime>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
