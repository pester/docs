...
```powershell
Should-BeBefore [[-Actual] <Object>] [[-Time] <String>] [-FromNow] [-Because <String>]
 [<CommonParameters>]
```
...
```powershell
Should-BeBefore [[-Actual] <Object>] [[-Time] <String>] [-Ago] [-Because <String>]
 [<CommonParameters>]
```
...
```powershell
Should-BeBefore [[-Actual] <Object>] [[-Expected] <DateTime>] [-Because <String>]
 [<CommonParameters>]
```
