...
id: New-Fixture
title: New-Fixture
description: Help page for the PowerShell Pester 'New-Fixture' command - This function generates two scripts, one that defines a functionand another one that contains its tests.
keywords:
  - PowerShell
  - Pester
  - Help
