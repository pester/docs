...
description: Help for Pester command 'Should-NotHaveType'. Asserts that the input is not of the expected type.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-NotHaveType [-Expected] <Object> [[-Actual] <Object>] [-Because <string>]
```
