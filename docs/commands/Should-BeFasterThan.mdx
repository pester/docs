...
description: Help page for the PowerShell Pester 'Should-BeFasterThan' command - Asserts that the provided [timespan] or [scriptblock] is faster than the expected [timespan].
keywords:
  - PowerShell
  - Pester
  - Help
