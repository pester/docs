...
description: Help for Pester command 'Should-BeEquivalent'. Compares two objects for equivalency, by recursively comparing their properties for equivalency.
keywords:
  - PowerShell
  - Pester
  - Help
