...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeExactly]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeGreaterOrEqual]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-BeLikeExactly]
```

### BeNullOrEmpty

```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-BeNullOrEmpty]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-BeOfType]
 [-ExpectedType <Object>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-BeTrue]
```

### BeFalse

```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-BeFalse]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-ExpectedValue <Object>]
 [-Because <Object>] [-Contain]
```

### Exist

```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-Exist]
 [-LiteralPath]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-FileContentMatch] [-ExpectedContent <Object>]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchExactly]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchMultiline]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-ExpectedContent <Object>] [-FileContentMatchMultilineExactly]
```
...
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 ...
 [-InParameterSet <Object>] [-HasArgumentCompleter] [-Alias <Object>]
```

### Match

```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-Match]
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>]
 [-RegularExpression <Object>] [-MatchExactly]
```

### Throw

```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-Throw]
 [-ExpectedMessage <Object>] [-ErrorId <Object>] [-ExceptionType <Object>] [-PassThru]
```
...
```powershell
Should [[-ActualValue] <Object>] [-Not] [-Because <Object>] [-Invoke]
 [-CommandName <Object>] [-Times <Object>] [-ParameterFilter <Object>] [-ExclusiveFilter <Object>]
 [-ModuleName <Object>] [-Scope <Object>] [-Exactly] [-CallerSessionState <Object>]
```
