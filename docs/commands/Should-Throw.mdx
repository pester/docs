...
id: Should-Throw
title: Should-Throw
description: Help for Pester command 'Should-Throw'. Asserts that a script block throws an exception.
keywords:
  - PowerShell
  - Pester
  - Help
...
Should-Throw [[-ExceptionMessage] <string>] [[-FullyQualifiedErrorId] <string>]
 [[-ExceptionType] <type>] -ScriptBlock <scriptblock> [-Because <string>]
