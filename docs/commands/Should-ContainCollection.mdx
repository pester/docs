...
description: Help for Pester command 'Should-ContainCollection'. Checks that the expected collection is present in the actual collection as an ordered subsequence. It does not compare the types of the input collections.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should-ContainCollection [-Expected] <Object> [[-Actual] <Object>] [-IgnoreOrder]
 [-Because <string>]
```
