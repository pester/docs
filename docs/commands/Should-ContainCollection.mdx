...
description: Help page for the PowerShell Pester 'Should-ContainCollection' command - Checks that the expected collection is present in the actual collection as an ordered subsequence. It does not compare the types of the input collections.
keywords:
  - PowerShell
  - Pester
  - Help
