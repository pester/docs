...
description: Help for Pester command 'Should-BeLessThan'. Compares the expected value to actual value, to see if the actual value is less than the expected value.
keywords:
  - PowerShell
  - Pester
  - Help
