...
**Note:** This currently only works for .NET types.  For custom types you need to use the `$MyClass.getType().Name | Should -Be "MyClassName"` form (see: https://github.com/pester/Pester/issues/1315)
