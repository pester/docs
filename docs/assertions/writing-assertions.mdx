...
- Name the function `Should-<Something>` so it reads like the built-in assertions and is easy to find.
...
BeforeAll {
    Import-Module "$PSScriptRoot/MyAssertions.psm1" -DisableNameChecking
}
