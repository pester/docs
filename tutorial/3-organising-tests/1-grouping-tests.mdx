...
Planetarium does not need `BeforeEach` yet, because every test builds what it needs and changes nothing. You will use `BeforeEach` in a later module when working with files.
:::
