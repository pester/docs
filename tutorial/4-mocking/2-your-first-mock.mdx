...
You can mock commands you did not write, including PowerShell's own. Here the target is `Import-Csv`, one layer deeper. Add this `Describe` block to the same test file:
