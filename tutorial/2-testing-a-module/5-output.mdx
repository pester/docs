...
The third audience is other tools like CI systems and automated reporting solutions. They prefer test results file in popular formats, which they can use to annotate failures and render reports.
