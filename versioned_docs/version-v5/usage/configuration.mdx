...
*This section was generated using Pester 5.6.1.*
...
| CodeCoverage.OutputFormat | Format to use for code coverage report. Possible values: JaCoCo, CoverageGutters | `string` | `'JaCoCo'` |
