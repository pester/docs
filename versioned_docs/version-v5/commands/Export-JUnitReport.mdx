...
description: Help for Pester command 'Export-JUnitReport'. Exports a Pester result-object to an JUnit-compatible XML-report
keywords:
  - PowerShell
  - Pester
  - Help
...
- [https://pester.dev/docs/v5/commands/Export-JUnitReport](https://pester.dev/docs/v5/commands/Export-JUnitReport)
