...
id: Should
title: Should
description: Help for Pester command 'Should'. Should is a keyword that is used to define an assertion inside an It block.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Should [[-ActualValue] <Object>] [[-Because] <Object>] [-Not] [-Exist]
```
...
Should [[-ActualValue] <Object>] [[-CommandName] <Object>] [[-Times] <Object>]
 ...
 [[-Scope] <Object>] [-Exactly] [[-Because] <Object>] [[-CallerSessionState] <Object>] [-Not]
 [-Invoke]
```
...
Depends on operator being used. See `Get-ShouldOperator -Name <Operator>` or https://pester.dev/docs/v5/assertions/ for help.
...
- [https://pester.dev/docs/v5/commands/Should](https://pester.dev/docs/v5/commands/Should)
- [https://pester.dev/docs/v5/assertions](https://pester.dev/docs/v5/assertions)
