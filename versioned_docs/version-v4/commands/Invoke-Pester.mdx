...
```powershell
Invoke-Pester [[-Script] <Object[]>] [[-TestName] <string[]>] [-EnableExit] [[-Tag] <string[]>]
 -OutputFile <string> [-ExcludeTag <string[]>] [-PassThru] [-CodeCoverage <Object[]>]
 [-CodeCoverageOutputFile <string>] [-CodeCoverageOutputFileEncoding <string>]
 [-CodeCoverageOutputFileFormat <string>] [-Strict] [-OutputFormat <string>] [-Quiet]
 [-PesterOption <Object>] [-Show <OutputTypes>]
```
