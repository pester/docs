...
declaration.
This is useful when you are testing a function that has a
...
current scope.
If there are multiple mocks with the same name, any subsequent
...
declaration.
This is useful when you are testing a function that validates
...
[https://pester.dev/docs/v4/commands/Assert-MockCalled](https://pester.dev/docs/v4/commands/Assert-MockCalled)

[https://pester.dev/docs/v4/commands/Assert-VerifiableMock](https://pester.dev/docs/v4/commands/Assert-VerifiableMock)

[https://pester.dev/docs/v4/commands/Describe](https://pester.dev/docs/v4/commands/Describe)
