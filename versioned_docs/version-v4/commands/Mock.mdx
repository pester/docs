...
id: Mock
title: Mock
description: Help for Pester command 'Mock'. Mocks the behavior of an existing command with an alternate implementation.
keywords:
  - PowerShell
  - Pester
  - Help
...
```powershell
Mock [[-CommandName] <string>] [[-MockWith] <scriptblock>] [[-ParameterFilter] <scriptblock>]
 [[-ModuleName] <string>] [[-RemoveParameterType] <string[]>]
 [[-RemoveParameterValidation] <string[]>] [-Verifiable]
```
